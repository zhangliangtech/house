    ...
    $('#showHouses').datagrid({
        ...
        columns: [[
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                        return "<a href='javascript:backPassHouse(" + row.id + ")'>撤销</a>";
                }
...
function backPassHouse(id) {
    $.messager.confirm('系统提示', '是否撤销', function (r) {
        if (r) {
            $.post('backPassHouse', {'id': id}, function (data) {
                if (data.result) {

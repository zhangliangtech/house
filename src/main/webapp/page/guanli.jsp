...
<div class="main wrap" style="height: 700px">
    <table class=house-list>
        ...
        <c:forEach items="${pageInfo.list}" var="house">
            <tr style="height: 135px">
                ...
                <td >
                    <dl>
                        <dt style="color: #f96b00">
                            <a href="detailHouse?id=${house.id}">${house.title}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${house.price}元/月
                        </dt>
                        <dd style="color: #969193">
                                ${house.districtName}${house.streetName},${house.floorage}平米<BR>联系方式：${house.contact}
                        </dd>
                    </dl>
                </td>
                <td class=house-type>
                    <span style="color: #838181;font-size: 15px">${house.state}</span>
                </td>
                <td class=house-type>
    ...
    <div class=pager>
        <ul>
            <li class=current><a href="http://localhost:8080/page/goGuanLi?page=1">首页</a></li>
            <li><a href="http://localhost:8080/page/goGuanLi?page=${pageInfo.pageNum-1}">上一页</a></li>
            <li><a href="http://localhost:8080/page/goGuanLi?page=${pageInfo.pageNum+1}">下一页</a></li>
            <li><a href="http://localhost:8080/page/goGuanLi?page=${pageInfo.pages}">末页</a></li>
        </ul>
